...
locals {
  k8s_m1 = {
    hostname = "k3s-m1"
    ipv4address = "192.168.30.101"
    ipv6address = "2001:470:ee86:30:192:168:30:101"
    pool_path = "/mnt/dsknvme/kvm"
  }
}
...
locals {
  k8s_m2 = {
    hostname = "k3s-m2"
    ipv4address = "192.168.30.102"
    ipv6address = "2001:470:ee86:30:192:168:30:102"
    pool_path = "/var/lib/libvirt/images"
  }
}
...
locals {
  k8s_m3 = {
    hostname = "k3s-m3"
    ipv4address = "192.168.30.103"
    ipv6address = "2001:470:ee86:30:192:168:30:103"
    pool_path = "/mnt/dvdsk/kvm"
  }
}
